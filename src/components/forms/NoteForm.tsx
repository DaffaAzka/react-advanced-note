...
export function NoteForm({ onSubmit }: NoteFormProps) {
  ...
  "dropdownClasses": "mt-2 z-50 w-full max-h-72 p-1 space-y-0.5 bg-white rounded-lg overflow-hidden overflow-y-auto [&::-webkit-scrollbar]:w-2 [&::-webkit-scrollbar-thumb]:rounded-full [&::-webkit-scrollbar-track]:bg-gray-100 [&::-webkit-scrollbar-thumb]:bg-gray-300 dark:[&::-webkit-scrollbar-track]:bg-neutral-700 dark:[&::-webkit-scrollbar-thumb]:bg-neutral-500 dark:bg-neutral-900 dark:border-neutral-700",
  ...
  "mode": "tags",
  "wrapperClasses": "relative ps-0.5 pe-9 py-2.5 sm:py-3 flex items-center flex-wrap text-nowrap w-full border-gray-200 rounded-lg text-start text-sm focus:border-blue-500 focus:ring-blue-500 dark:bg-neutral-900 dark:border-neutral-700 dark:text-neutral-400",
  "tagsItemTemplate": "<div class=\"flex flex-nowrap items-center relative z-10 bg-blue-100 border border-blue-200 rounded-full px-3 mx-2 dark:bg-blue-900/30 dark:border-blue-700\"><div class=\"size-4 me-1.5\" data-icon></div><div class=\"whitespace-nowrap text-blue-800 dark:text-blue-200 text-xs font-medium\" data-title></div><div class=\"inline-flex shrink-0 justify-center items-center size-4 ms-1.5 rounded-full text-blue-600 bg-blue-200 hover:bg-blue-300 focus:outline-hidden focus:ring-2 focus:ring-blue-400 text-xs dark:bg-blue-800 dark:hover:bg-blue-700 dark:text-blue-300 cursor-pointer\" data-remove><svg class=\"shrink-0 size-2.5\" xmlns=\"http://www.w3.org/2000/svg\" width=\"24\" height=\"24\" viewBox=\"0 0 24 24\" fill=\"none\" stroke=\"currentColor\" stroke-width=\"2\" stroke-linecap=\"round\" stroke-linejoin=\"round\"><path d=\"M18 6 6 18\"/><path d=\"m6 6 12 12\"/></svg></div></div>",
  "tagsInputId": "hs-tags-input",
  "tagsInputClasses": "px-2 min-w-20 rounded-lg order-1 border-transparent focus:ring-0 sm:text-sm outline-hidden dark:bg-neutral-900 dark:placeholder-neutral-500 dark:text-neutral-400",
  ...
  "extraMarkup": "<div class=\"absolute top-1/2 end-3 -translate-y-1/2\"><svg class=\"shrink-0 size-3.5 text-gray-500 dark:text-neutral-500\" xmlns=\"http://www.w3.org/2000/svg\" width=\"24\" height=\"24\" viewBox=\"0 0 24 24\" fill=\"none\" stroke=\"currentColor\" stroke-width=\"2\" stroke-linecap=\"round\" stroke-linejoin=\"round\"><path d=\"m7 15 5 5 5-5\"/><path d=\"m7 9 5-5 5 5\"/></svg></div>"
        ...
        <div className="flex justify-end gap-4">
          <button
            type="button"
            className="button text-white bg-purple-700 px-3 py-2 rounded-lg">
            Submit
          </button>
          <Link
            to=".."
            type="button"
            className="button text-white bg-blue-700 px-3 py-2 rounded-lg">
            Back
          </Link>
        </div>
      </form>
